...
// First arg of the last `name` keyword.  For singletons (COLOR, EDTCDE).
// Indicators are ignored: runtime evaluates them, design-time = last wins.
...
// Build a keywords[] from the legacy palette shortcut spec
...
// Human-readable render of a single keyword: "DSPATR(RI)", "OVERLAY".
